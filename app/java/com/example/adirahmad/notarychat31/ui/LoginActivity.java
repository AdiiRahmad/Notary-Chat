...
import com.example.adirahmad.notarychat31.MainActivity;
...
public class LoginActivity extends AppCompatActivity {
    ...
    public void clickLogin(View view) {
        ...
        if (validate(username, password)) {
            ...
            Toast.makeText(this, "Email Anda tidak tersedia atau Password salah", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    class AuthUtils {
        ...
        void createUser(String email, String password) {
            waitingDialog.setIcon(R.drawable.ic_add_friend)
                    .setTitle("Mendaftarkan Akun anda ke Server ....")
                            ...
                            if (!task.isSuccessful()) {
                                new LovelyInfoDialog(LoginActivity.this) {
                                    ...
                                    public LovelyInfoDialog setConfirmButtonText(String text) {
                                        ...
                                        .setTitle("Proses Registrasi Gagal")
                                        .setMessage("Password tidak Aman !!!")
                                        .setConfirmButtonText("Ok")
                                        .setCancelable(false)
                                        .show();
                            } else {
                                initNewUserInfo();
                                Toast.makeText(LoginActivity.this, "Registrasi dan Login ke Akun Berhasil", Toast.LENGTH_SHORT).show();
                                startActivity(new Intent(LoginActivity.this, MainActivity.class));
                                LoginActivity.this.finish();
                            }
                        }
                            ...
                            if (!task.isSuccessful()) {
                                ...
                                new LovelyInfoDialog(LoginActivity.this) {
                                    ...
                                    public LovelyInfoDialog setConfirmButtonText(String text) {
                                        ...
                                        .setMessage("Email tidak tersedia atau Password salah")
                                        .setCancelable(false)
                                        .setConfirmButtonText("Ok")
                                        .show();
                            } else {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            new LovelyInfoDialog(LoginActivity.this) {
                                ...
                                public LovelyInfoDialog setConfirmButtonText(String text) {
                                    ...
                                    .setTitle("Fitur lupa Password")
                                    .setMessage("Mengirimkan Password anda ke " + email)
                                    .setConfirmButtonText("Ok")
                                    .show();
                        }
                    })
                ...
                public void onFailure(@NonNull Exception e) {
                    new LovelyInfoDialog(LoginActivity.this) {
                        ...
                        public LovelyInfoDialog setConfirmButtonText(String text) {
                            ...
                            .setIcon(R.drawable.ic_pass_reset)
                            .setTitle("Gagal")
                            .setMessage("Gagal mengirimkan password ke" + email)
                            .setConfirmButtonText("Ok")
                            .show();
                }
            });
